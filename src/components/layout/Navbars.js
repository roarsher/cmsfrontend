...
const STUDENT_LINKS = [
  ...
  { label: "Routine",    path: "/student/routine" },
  { label: "Results",    path: "/student/results" },
  // { label: "🔔 Alerts",   path: "/student/notifications" },
  // { label: "🔔 Alerts",   path: "/student/notifications" },
...
const ADMIN_LINKS = [
  ...
  { label: "Attendance",      path: "/admin/attendance-records" },
  //{ label: "🔔 Alerts",        path: "/admin/notifications" },
