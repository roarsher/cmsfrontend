      ...
      {isOpen && (
        <div className="w-[370px] h-[540px] bg-white rounded-3xl shadow-2xl border border-slate-200 flex flex-col overflow-hidden"
          ...
          <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3 bg-slate-50">
            {chatHistory.map((chat) => (
              <div key={chat.id} className={`flex ${chat.sender === "user" ? "justify-end" : "justify-start"}`}>
                ...
                <div className={`max-w-[85%] text-sm leading-relaxed ${
                  chat.sender === "user"
                    ? "bg-slate-800 text-white px-4 py-2.5 rounded-2xl rounded-tr-sm shadow-sm"
                    : "bg-white text-slate-700 px-4 py-3 rounded-2xl rounded-tl-sm border border-slate-100 shadow-sm"
                }`}>
                  {chat.sender === "ai" ? (
                    <div className={`
                      ...
                      [&_h1]:text-base [&_h1]:font-bold [&_h1]:text-slate-800 [&_h1]:mt-2 [&_h1]:mb-1
                      [&_h2]:text-sm [&_h2]:font-bold [&_h2]:text-slate-800 [&_h2]:mt-2 [&_h2]:mb-1
                      [&_h3]:text-sm [&_h3]:font-semibold [&_h3]:text-slate-700 [&_h3]:mt-1.5 [&_h3]:mb-0.5
                      [&_table]:w-full [&_table]:border-collapse [&_table]:my-2 [&_table]:text-xs
                      [&_th]:bg-slate-100 [&_th]:px-2 [&_th]:py-1.5 [&_th]:text-left [&_th]:font-semibold [&_th]:text-slate-600 [&_th]:border [&_th]:border-slate-200
                      [&_td]:px-2 [&_td]:py-1.5 [&_td]:border [&_td]:border-slate-100 [&_td]:text-slate-700
                      [&_tr:nth-child(even)_td]:bg-slate-50
                      [&_code]:bg-slate-100 [&_code]:px-1 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-xs [&_code]:text-slate-600
                      [&_blockquote]:border-l-2 [&_blockquote]:border-yellow-400 [&_blockquote]:pl-3 [&_blockquote]:text-slate-500 [&_blockquote]:italic
            ...
            {isLoading && (
              <div className="flex items-center gap-2 ml-9">
                <div className="w-7 h-7 rounded-full bg-slate-800 flex items-center justify-center text-yellow-400 font-black text-xs mr-0 shrink-0">B</div>
                <div className="bg-white rounded-2xl rounded-tl-sm px-4 py-3 flex items-center gap-1.5 shadow-sm border border-slate-100">
